...
Пользовательская документация и руководства по интеграции доступны на [сайте
документации Tea](https://tea-hq.github.io/tea-docs/). Исходные файлы поддерживаются
в [репозитории документации Tea](https://github.com/tea-hq/tea-docs).
